...
const AGENTLIVE = (function(){
  ...
  function screenContext(){
    ...
    if(inTask&&typeof CUR!=='undefined'&&CUR&&CUR.task){
      ...
      if(junior){
        return head+'Ученик младших классов (1–4). На экране простая задачка «'+t.title+'» (остров «Начальная школа»): '+t.story+
          ' Вопрос: '+t.q+'. Объясняй очень просто, короткими предложениями, можно с примерами из жизни. Ответ не говори — помоги посчитать самому.';
      }
