...
(function(){
  const L100 = {
    ...
    explain: [
      ...
      "Обозначают плотность греческой буквой ρ, читается «ро». Формула простая: ρ = m / V, то есть масса делится на объём. В лаборатории массу берут на весах, в граммах, а объём — мензуркой, в кубических сантиметрах.",
      "Считаем пример. Масса 6 г, объём 3 см³, значит ρ = 6 : 3 = 2 г/см³. Полезно вслушаться в единицу: г/см³ — это «сколько граммов в одном кубическом сантиметре», ровно то самое, о чём мы говорили в начале.",
      ...
      "Проверим на числах. Плотность 2 г/см³, объём 5 см³ — масса 2 · 5 = 10 г. И обратная задача: масса 10 г при плотности 2 даёт объём 10 : 2 = 5 см³. Формула работает в обе стороны, поэтому задач три вида, а формула одна.",
      ...
      "В тех же таблицах плотность встречается в кг/м³, и это путает. У воды 1 г/см³ — это 1000 кг/м³. Число другое, вещество то же: просто кубик взяли не сантиметровый, а метровый. Запомни связку 1 г/см³ = 1000 кг/м³, чтобы не переводить наугад.",
      "Теперь самое интересное: почему одно плавает, а другое тонет. Правило короткое — сравни плотность тела с плотностью жидкости. Лёд 0,9 против воды 1: лёд легче, он всплывает и часть остаётся над водой. Железо 7,8 против 1 — тонет.",
